...
module fp_accelerator
  ...
  real(kind=wp), save :: tol
  integer,       save :: mvec

  type(NodeVar), dimension(:,:), allocatable, save :: v, w
  real(kind=wp), dimension(:,:), allocatable, save :: h
  integer, dimension(:), allocatable, save  :: next, prev
  ...
  contains
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine fpa_init (f, maxv, vtol)
      ...
      type(NodeVar), dimension(:), intent(in) :: f
      ...
      allocate (v(size(f),n), w(size(f),n))
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine fpa_correction (itr, f)
      ...
      type(NodeVar), dimension(:), intent(inout) :: f
