...
module element_mfe
  ...
  public :: eltfy, eltpp, cres, cmtx, cdgl, regrhs
  ...
  contains
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine eltfy (t, errc)
      ...
      integer :: k
      real(kind=wp), dimension(nepn,nelt) :: r0save, r1save
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine cres ()
      ...
      integer :: j, k
      real(kind=wp) :: nU0, nU1, term, term1, term2
      real(kind=wp), dimension(npde) :: c
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine cmtx (factor)
      ...
      integer :: j, k
      real(kind=wp) :: fac, aa, ab, bb, term
      real(kind=wp), dimension(npde) :: c
