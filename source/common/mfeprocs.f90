...
module mfe_procs
  ...
  public :: eval_residual, eval_jacobian, eval_udot

  ! Storage for the Jacobian matrix
  type(NodeMtx), dimension(:), allocatable, private :: jac_lowr, jac_diag, jac_uppr
