...
module fp_accelerator
  ...
  real(wp), allocatable, save :: v(:,:,:), w(:,:,:)
  real(wp), allocatable, save :: h(:,:)
  integer, allocatable, save  :: next(:), prev(:)
  ...
  contains
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine fpa_init (f, maxv, vtol)
      ...
      real(wp), intent(in), optional :: vtol
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine fpa_correction (itr, f)
      ...
      ! local variables.
      real(wp)                :: s, c(mvec+1), hkk, hkj, cj
      integer                 :: i, j, k, tmp, new, nvec
